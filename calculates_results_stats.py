...
# Creates empty dictionary for results_stats_dic
    ...
    try: 
        ...
        results_stats_dict['pct_match'] = 0.0
    ...
    #    print('n_dogs_img--->',results_stats_dic['n_dogs_img'])
    #    results_stats_dic['pct_correct_dogs'] = 0.0
        #results_stats_dic['pct_correct_dogs'] = results_stats_dic['n_correct_dogs']*100/results_stats_dic['n_dogs_ima']
    #except:
        #results_stats_dic['pct_correct_dogs'] = 0.0
        #print("Errrrorrr")
    ...
    #print('n_dog_img--->',results_stats_dic['n_dogs_img'])
    #results_stats_dic['pct_correct_breed'] = 0.0
    #try:
        #results_stats_dic['pct_correct_breed'] = 100*results_stats_dic['n_correct_breed']/results_stats_dic['n_dog_img']
     #   print('n_correct_breed--->',results_stats_dic['n_correct_breed'])
     #   print('n_dog_img--->',results_stats_dic['n_dog_img'])
     #   results_stats_dic['pct_correct_breed'] = 0.0
    #except:
     #   results_stats_dic['pct_correct_breed'] = 0.0
        #print("Errrrorrr")
